...
public sealed class GetFootballDataSnapshotHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return new FootballDataSnapshotDto(
            ...
            computedGroupStandings.Select(standing => new FootballGroupStandingDto(standing.GroupName, standing.TeamExternalId, standing.Played, standing.Won, standing.Drawn, standing.Lost, standing.GoalsFor, standing.GoalsAgainst, standing.GoalDifference, standing.Points)).ToArray(),
